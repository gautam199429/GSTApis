    ...
    */
    ...
    
    {
    	...
    	try {
    		 ...
    		 * Encoded Json
    		 */
    		String encodedJson = AESEncryption.encodeBase64String(jsonpayloadr.toString().getBytes());
    		 ...
    		 */
    		String sek="akXSEqkXIJLmVd+\\/vTvIjp3iC4JcnkxcAZvrXtOfOyl7zlDfF8ODnmg3HpxsJETp";
    		byte[] authEK = AESEncryption.decrypt(sek, decodeBase64StringTOByte("oqeyGzGRloVqphg12LFNLgzODxaf+UUehBDN8o+lxc4="));
...
//			System.out.println(refid);
			...
			String sign2 = AESEncryption.generateSign("9925F4", "AHWPB0871H", sek, "oqeyGzGRloVqphg12LFNLgzODxaf+UUehBDN8o+lxc4=");
